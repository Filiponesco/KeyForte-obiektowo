...
TForm1 *Form1;
string klawisz;
clock_t start,stop;//do liczenia odstêpów
        ...
        : TForm(Owner)
{
        ...
        if(plik.good()==true)
        {
                ...
                kursor = plik.tellg();
                if(kursor == 0) Czas->Caption="Nagraj utwór!";  //jesli plik pusty
                else Czas->Caption="Nagraj kolejny utwór";            //jesli plik niepusty
        }
        if(plik.good()==false) //jesli plik nie istnieje
        {
                Czas->Caption="Nagraj utwór!";
        }
        plik.clear();
        plik.close();
}
...
void __fastcall TForm1::stopClick(TObject *Sender)
{
        ...
        else Czas->Caption="Nagrano utwór";
        plik.clear();
        plik.close();
...
void __fastcall TForm1::odtworzClick(TObject *Sender)
{
        ...
        else  //jesli plik istnieje
        {
            ...
            else //jesli plik nie jest pusty
            {
                ...
                Czas->Caption="Nagraj kolejny utwór!";
            }
        }
        plik.clear();
        plik.close();
